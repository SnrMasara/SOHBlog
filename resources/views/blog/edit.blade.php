...
<div class="py-15">
<h1 class="text-4xl"> Update Post</h1>
</div>
</div>
...
<div class="w-4/5 m-auto pt-20">
    ...
    @csrf
    @method('PUT')
    <input type="text" name="title" value="{{$post->title}}" class="bg-orange-50 block border-b-2 w-full h-20 text-6xl outline-none" >
    <textarea name="description" class="py-20 bg-orange-50 border-b-2 w-full h-60 text-xl outline-none">{{$post->description}}</textarea>
